    ...
    return (
        ...
        <form onSubmit={submitHandler}>
            <ul className="form-container">
                ...
                <li>
                    <button type="submit" className="button primary black">Update</button>
                </li>
                <li>
                    <button type="button" onClick={handleLogout} className="button secondary will-full">Logout</button>
